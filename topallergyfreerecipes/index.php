...
switch( $action ) {
    ...
    case 'list_recipes' :
        ...
        break;
//    case 'get_recipes_by_allergy_only' :
//        $category_id = filter_input(INPUT_GET, 'category_id', 
//            FILTER_VALIDATE_INT);
//        if ($category_id == NULL || $category_id == FALSE) {
//            $category_id = 1;
...
//        $recipes = get_recipes_by_allergy_only($allergies);
//        $category_name = get_category_name($category_id);
//        $categories = get_categories();
//       include('recipe_results_all.php');
//       break;
